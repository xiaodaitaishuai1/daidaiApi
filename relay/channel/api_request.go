...
// PassThroughCodexSafeHeaders copies client headers that do not carry proxy
// credentials or connection-specific transport state. Adapter-owned headers
// are applied after this function and therefore remain authoritative.
func PassThroughCodexSafeHeaders(c *gin.Context, req *http.Header) {
	if c == nil || c.Request == nil || req == nil {
		return
	}
